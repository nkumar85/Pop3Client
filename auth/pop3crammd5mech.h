...
#ifndef __POP3__CRAMMD5__AUTH__H
#define __POP3__CRAMMD5__AUTH__H

namespace pop3
{
	class Pop3CramMd5Mech : public Pop3AuthModule
	{
		...
		public:
			Pop3CramMd5Mech() : auth_state(POP3_AUTH_INIT), mech_name("CRAM-MD5")
			{
