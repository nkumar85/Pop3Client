...
#ifndef __POP3__PLAIN__AUTH__H
#define __POP3__PLAIN__AUTH__H

namespace pop3
{
	class Pop3PlainMech : public Pop3AuthModule
	{
		...
		public:
			Pop3PlainMech() : auth_state(POP3_AUTH_INIT), mech_name("PLAIN")
			{
