...
#ifndef __POP3__CLR__AUTH__H
#define __POP3__CLR__AUTH__H

namespace pop3
{
	class Pop3ClearMech : public Pop3AuthModule
	{
		...
		public:
			Pop3ClearMech() : auth_state(POP3_AUTH_INIT), mech_name("CLEAR")
			{
