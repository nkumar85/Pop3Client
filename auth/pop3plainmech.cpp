...
namespace pop3
{
	POP3_AUTH_STATE_E Pop3PlainMech::AuthStart(const Pop3AuthData_t& auth_data)
	{
	...
	POP3_AUTH_STATE_E Pop3PlainMech::AuthStep(string& auth_str)
	{
		...
		switch(step_count)
		{
			case 1:
			{
				string auth_info = auth_data.auth_name + '\0' + auth_data.user_name + '\0' + auth_data.user_pass;
